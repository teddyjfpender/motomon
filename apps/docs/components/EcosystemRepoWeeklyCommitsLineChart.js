...
import data from '../public/ecosystem_data/ecosystem_processed_weekly_data.json'; // Make sure to import the weekly data
...
function EcosystemRepoWeeklyCommitsLineChart() {
    return (
      <LineChart width={750} height={400} data={data} margin={{ top: 20, right: 40, left: 100, bottom: 50 }}>
        <XAxis dataKey="date" axisLine={false} height={50}>
          <Label value="Week Starting" position="insideBottomLeft" offset={-5} /> 
        </XAxis>
...
export default EcosystemRepoWeeklyCommitsLineChart;
