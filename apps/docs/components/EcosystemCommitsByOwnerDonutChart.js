...
import data from '../public/ecosystem_data/pie-charts/ecosystem_processed_owner_data.json';
...
function EcosystemCommitsByOwnerDonutChart() {
...
export default EcosystemCommitsByOwnerDonutChart;
